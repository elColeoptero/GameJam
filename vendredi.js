...
var vendredi = function () {
  ...
  p.preload = function() {
    ...
    console.log("load balledm");
    balletp = loadImage('/assets/Vendredi/900x400/BalleTP.png');
    console.log("load balletp");
    fond = loadImage('/assets/Vendredi/900x400/Background_with_borders.png');
    console.log("load fond");
    //load des sons
    /*
    bonus = loadSound("/assets/Vendredi/sons/Point_Gagne.wav");
    malus = loadSound("/assets/Vendredi/sons/Point_Perdu.wav");
    victoire = loadSound("/assets/Vendredi/sons/Win.wav");
    musique = loadSound("/assets/Vendredi/sons/Son_Combat.mp3");
    rebond = loadSound("/assets/Vendredi/sons/Ball.wav");*/
  }
